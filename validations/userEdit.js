...
let user = body('user').notEmpty().withMessage('El nombre de usuario no puede quedar vacío').isLength({min:2,max:20}).withMessage('minimo 2 caracteres, maximo 20')

let fullName = body('fullName').notEmpty().withMessage('El nombre de usuario no puede quedar vacío').isLength({min:2}).withMessage('Al menos 2 caracteres')
